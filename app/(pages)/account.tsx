  ...
  useEffect(() => {
    const unsubscribe = auth.onAuthStateChanged(async (user) => {
      if (user) {
        ...
        setEmail(bandData?.email);
        setLocation(bandData?.location);
        selectGenre(bandData?.genre);
        setBio(bandData?.bio);
        setPhone(bandData?.phone);
        setPrice(bandData?.pricePerHour);
        setHours(bandData?.hours);
        setMinutes(bandData?.minutes);
        setInstagram(bandData?.instagram);
        // setImage(bandData?.image)
      } else {
        Alert.alert(
          "Error",
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View>
          <ThemeText>Account View</ThemeText>
          ...
          <Button onPress={() => submit()} title="Update" />
        </View>
