  ...
  return (
    <SafeAreaView style={styles.container} edges={["bottom"]}>
      ...
      <View style={{ padding: 20, gap: 12 }}>
        ...
        <ThemeText type="default">Welcome to Gig Dogs.</ThemeText>

        <ThemeText type="default">
          {`These Terms and Conditions ("Terms") govern your access to and use of
          the Gig Dogs mobile application and any related services
          (collectively, the "Platform").`}
        </ThemeText>

        <ThemeText type="default">
          {`Gig Dogs is owned and operated by Jacomo Manfredi, a sole proprietor
          ("Gig Dogs," "we," "us," or "our").`}
        </ThemeText>

        <ThemeText type="default">
          By accessing or using Gig Dogs, you agree to be bound by these Terms.
        ...
        <ThemeText type="default">
          Gig Dogs is intended solely for individuals who are 18 years of age or
          older. By using the Platform, you represent and warrant that you are
        ...
        <ThemeText type="default">
          Gig Dogs is a listing and discovery platform that allows musical bands
          to create profiles and publish information including, but not limited
          to:
        </ThemeText>
        ...
        <ThemeText type="default">• Instagram or social media links</ThemeText>
        ...
        <ThemeText type="default">
          Gig Dogs does not employ, manage, supervise, control, or endorse any
          band listed on the Platform.
        </ThemeText>

        <ThemeText type="default">
          Gig Dogs does not book performances, negotiate contracts, process
          payments, or participate in any agreements between users and bands.
        </ThemeText>

        <ThemeText type="default">
          Gig Dogs acts solely as a passive platform for information display.
        </ThemeText>
        ...
        <ThemeText type="default">• Disputes between users and bands</ThemeText>
        ...
        <ThemeText type="default">
          ...
          entirely outside the Platform and are solely between the user and the
          band.
        </ThemeText>
        ...
        <ThemeText type="default">Gig Dogs does not guarantee:</ThemeText>
        ...
        <ThemeText type="default">
          ...
          contractors, agents, partners, or representatives of Gig Dogs.
        </ThemeText>
        <ThemeText type="default">
        ...
        <ThemeText type="default">
          By using Gig Dogs, you acknowledge that hiring live performers
        ...
        <ThemeText type="default">
          ...
          Jacomo Manfredi and Gig Dogs from any and all claims, damages,
        ...
        <ThemeText type="default">
          Gig Dogs’ total liability, if any, shall not exceed $100.
        </ThemeText>

        {/* 8. Indemnification */}
        <ThemeText type="subtitle">8. Indemnification</ThemeText>
        <ThemeText type="default">
          {`You agree to indemnify, defend, and hold harmless Jacomo Manfredi and
          Gig Dogs from any claims, lawsuits, damages, losses, liabilities, or
          expenses (including attorney’s fees) arising out of:`}
        </ThemeText>
        ...
        <ThemeText type="default">
          By creating an account, bands grant Gig Dogs a non-exclusive,
          worldwide, royalty-free license to display, reproduce, and distribute
          the information and content they upload for the purpose of operating
        ...
        <ThemeText type="default">
          Gig Dogs reserves the right to remove any content at its sole
          discretion.
        </ThemeText>
        ...
        <ThemeText type="default">
          Gig Dogs may suspend or terminate access at any time.
        </ThemeText>

        {/* 11. Account Termination */}
        <ThemeText type="subtitle">11. Account Termination</ThemeText>
        <ThemeText type="default">
          Gig Dogs reserves the right to suspend or permanently terminate any
        ...
        <ThemeText type="default">
          Gig Dogs disclaims all warranties, including:
        </ThemeText>

        <ThemeText type="default">• Merchantability</ThemeText>
        <ThemeText type="default">• Fitness for a particular purpose</ThemeText>
        ...
        <ThemeText type="default">
          ...
          laws of the Commonwealth of Virginia, without regard to conflict of
          law principles.
        </ThemeText>
        ...
        <ThemeText type="default">
          Gig Dogs may update these Terms at any time. Continued use of the
        ...
        <ThemeText type="default">
          By using Gig Dogs, you acknowledge that you have read, understood, and
